...
var myFriends: [Friend] =
    [Friend(userName: "Мария Берсенева", avatarPath:"berseneva1", isOnline:0, id:1 ),
     Friend(userName:"Анастасия Стежко", avatarPath:"stezhko1", isOnline:0, id:2 ),
     Friend(userName:"Сергей Афанасьев", avatarPath:"sergei afanasiev1", isOnline:0, id:3),
     Friend(userName:"Николай Рассказов", avatarPath:"NikolayRasskazov1", isOnline:0, id:4),
     Friend(userName:"Лаутаро Мартинес", avatarPath:"lautaro martinez1", isOnline:0, id:5),
     Friend(userName:"Алексей Елкин", avatarPath:"DserFour", isOnline:0, id:6),
     Friend(userName:"Дмитрий Миронов", avatarPath:"UserThree", isOnline:0, id:7),
     Friend(userName:"Павел Зонтиченко", avatarPath:"CserFour", isOnline:0, id:8)
]
